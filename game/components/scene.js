...
const getInitialState = (containerSize, selectedNFTImage) => {
...
export default function Scene(containerSize) {
  ...
  return (
    <svg width={viewWidth} height={projectDistance(height)} className='scene'>
      ...
      <Paddle width={projectDistance(width)} height={projectDistance(paddle.height)} {...projectVector(paddle.position)} selectedNFTImage={containerSize.selectedNFTImage} />
